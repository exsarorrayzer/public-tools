...
class CredentialExcluderApplication:
    def __init__(self, root):
        self.root = root
        self.root.title("Credential Stream Excluder")
        ...
        self.theme_accent = "#ef4444"
        self.theme_success = "#10b981"
        self.theme_hover = "#f87171"
    ...
    def initialize_interface(self):
        title_label = tk.Label(
            self.root, 
            text="Enterprise Credential Excluder", 
    ...
    def process_dataset(self):
        ...
        if not search_criterion:
            messagebox.showwarning("Validation Error", "Exclusion criterion parameter cannot be null.")
            return
        ...
        try:
            ...
            if removed_count == 0:
                messagebox.showinfo("Operation Result", f"Zero matches found for target domain: '{search_criterion}'. Nothing to remove.")
                return
            ...
            destination_path = filedialog.asksaveasfilename(
                ...
                initialfile=f"cleaned_output_minus_{search_criterion}.txt"
            )
            ...
            if destination_path:
                ...
                messagebox.showinfo(
                    ...
                    f"Successfully excluded {removed_count} records.\nSaved {len(filtered_dataset)} clean records to: {os.path.basename(destination_path)}"
                )
...
if __name__ == "__main__":
    ...
    application_instance = CredentialExcluderApplication(interface_root)
